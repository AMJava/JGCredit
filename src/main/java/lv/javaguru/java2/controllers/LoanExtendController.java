...
@Controller
public class LoanExtendController extends ErrorHandlingController{
    ...
    public ModelAndView executeGetRequest(HttpServletRequest request) throws Exception {
        try {
            ...
            loanService.extendActiveUserLoan(userService.gerSessionUserDTO().getId());
            return new ModelAndView("redirect", "model", new MVCModel("/java2/loans",null));
